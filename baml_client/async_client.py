...
class BamlAsyncClient:
    ...
    async def ExtractCryptoSentiment(
        self,
        news: str,
        baml_options: BamlCallOptions = {},
    ) -> List[types.CryptoSentiment]:
      ...
      return cast(List[types.CryptoSentiment], raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def ExtractCryptoSentiment(
        self,
        news: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[List[partial_types.CryptoSentiment], List[types.CryptoSentiment]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[List[partial_types.CryptoSentiment], List[types.CryptoSentiment]](
        raw,
        lambda x: cast(List[partial_types.CryptoSentiment], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(List[types.CryptoSentiment], x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
